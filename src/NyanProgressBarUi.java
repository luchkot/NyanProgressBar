...
public class NyanProgressBarUi extends BasicProgressBarUI {
	...
	private static final Color r1 = new Color(128, 70, 82);
	private static final Color r2 = new Color(133, 103, 70);
	private static final Color r3 = new Color(123, 132, 92);
	private static final Color r4 = new Color(55, 119, 81);
	private static final Color r5 = new Color(50, 114, 135);
	private static final Color r6 = new Color(32, 81, 144);
	private static final Color r7 = new Color(98, 80, 139);
	...
	protected void paintIndeterminate(Graphics g2d, JComponent c) {
		...
		LinearGradientPaint baseRainbowPaint = new LinearGradientPaint(0, JBUI.scale(2), 0, h - JBUI.scale(6),
				...
				new Color[]{r1, r2, r3, r4, r5, r6, r7});
